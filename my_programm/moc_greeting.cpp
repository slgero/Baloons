...
QT_MOC_LITERAL(1, 9, 10), // "GetOrgName"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 21) // "on_pushButton_clicked"

    },
    "Greeting\0GetOrgName\0\0on_pushButton_clicked"
};
...
void Greeting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GetOrgName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Greeting::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Greeting::GetOrgName)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Greeting::GetOrgName(QString _t1)
{
